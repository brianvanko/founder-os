    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold text-slate-900">3-Year Goals</h1>
          <p className="text-slate-600 mt-2">
            Your medium-term vision (36 months)
          </p>
        </div>
        <Link
          href="/dashboard/goals/new?timeframe=THREE_YEAR"
